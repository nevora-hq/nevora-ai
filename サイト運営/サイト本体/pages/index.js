...
const PINNED_CATEGORY_NAMES = ["AIチャット・対話AI", "画像生成AI", "AIの基礎知識"];
...
export default function Home({
  ...
  return (
    <Layout
      title="AI活用の総合ガイド｜NEVORA｜ChatGPT・画像生成AI・業務効率化の情報"
          ...
          <div className="container container--wide">
            <div className="mascot-comment mascot-comment-home">
              ...
              <div className="mascot-comment-bubble">
                <span className="mascot-comment-name">{AIMIN.name}</span>
                <p className="mascot-comment-text">{AIMIN.homeComment}</p>
              </div>
            </div>

            <Link href={`/category/${encodeURIComponent("AIの基礎知識")}`} className="diagnosis-banner">
              <img
                src={AIMIN.normalImage}
                alt={AIMIN.name}
                width={56}
              ...
              <span className="diagnosis-banner-text">
                <span className="diagnosis-banner-title">AIをはじめて使う方へ</span>
...
// 1024px未満は従来どおり、人気カテゴリー(AIチャット・対話AI/画像生成AI/AIの基礎知識)のみ表示し、
