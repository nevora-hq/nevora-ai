...
export default function WorryPage({
  ...
  return (
    ...
    >
      ...
      {/* 7. この困りごとの記事(0件の場合はセクションごと非表示) */}
      {posts.length > 0 && (
        <section className="article-section">
          <h2 className="home-section-title">この困りごとの記事</h2>
      ...
      {relatedWorries.length > 0 && (
        <section className="article-section">
          <h2 className="home-section-title">関連する他の困りごと</h2>
      ...
      {/* 10. 比較CTA(この困りごとで絞り込んだ/compareへ。9とは行き先・文言を分ける) */}
